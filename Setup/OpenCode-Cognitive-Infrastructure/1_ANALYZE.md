...
- [ ] Check for existing `opencode.json` or `AGENTS.md`
...
If ROLE.md or AGENTS.md exists, extract:
...
| AGENTS.md | Existing identity | Plan upgrade |
| README.md | Documentation | Extract context |
| opencode.json | Existing config | Preserve settings |
| .opencode/ | Existing infrastructure | Plan upgrade |
...
Consider how your custom agent complements these.

### MCP Server Discovery
Check for commonly used MCP servers:
